...
void UInventoryWidget::SetItemInfo(const FIteminfo& info)
{
	...
	case EItemType::EQUIPMENT:
		if (Cast<FEquipment>(&info)->equipment_Type == EEquipmentType::WEAPON) {
			str = "체력 : " + FString::FromInt(Cast<FEquipment>(&info)->equipmentStat.HP) + "\n" +
				"공격력 : " + FString::FromInt(Cast<FEquipment>(&info)->equipmentStat.ATC) + "\n" +
				"민첩성 : " + FString::FromInt(Cast<FEquipment>(&info)->equipmentStat.DEX);
		}
		else {
			str = "체력 : " + FString::FromInt(Cast<FEquipment>(&info)->equipmentStat.HP) + "\n" +
				"방어력 : " + FString::FromInt(Cast<FEquipment>(&info)->equipmentStat.DEF) + "\n" +
				"민첩성 : " + FString::FromInt(Cast<FEquipment>(&info)->equipmentStat.DEX);
		}
		break;
	case EItemType::MATERIAL:

		str = "체력 : " + FString::FromInt(Cast<FItemMaterial>(&info)->materialStat.HP) + "\n" +
			"공격력 : " + FString::FromInt(Cast<FItemMaterial>(&info)->materialStat.ATC) + "\n" +
			"방어력 : " + FString::FromInt(Cast<FItemMaterial>(&info)->materialStat.DEF) + "\n" +
			"민첩성 : " + FString::FromInt(Cast<FItemMaterial>(&info)->materialStat.DEX);
		break;
	}
