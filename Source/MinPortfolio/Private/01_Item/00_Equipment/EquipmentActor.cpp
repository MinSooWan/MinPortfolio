...
void AEquipmentActor::ItemChange(APlayerCharacter* player, const FEquipment* info, AItemActor* item)
{
	
}

void AEquipmentActor::ItemChange_Default(APlayerCharacter* player, const FEquipment* info, AItemActor* item)
{
